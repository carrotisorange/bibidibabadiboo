...
class OperatorSummaryStatsForm extends KeyingVendorForm
{
    private $inputFilter;
    ...
    {
      parent::__construct('operatorSummaryStats', $serviceAuth, $serviceKeyingVendor);
    ...
    public function init()
    {
        ...
        $this->addDateStart();
        $this->addDateEnd();
        $this->addKeyingVendorId(KeyingVendorService::SRC_METRICS_OSS_FORM);
        $this->addSubmit();
    }
    ...
    public function addInputFilters()
    {
        ...
        $this->addKeyingVendorIdInputFilter(KeyingVendorService::SRC_METRICS_OSS_FORM);
