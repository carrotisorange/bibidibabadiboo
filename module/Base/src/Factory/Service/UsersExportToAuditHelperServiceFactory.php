...
class UsersExportToAuditHelperServiceFactory extends ServiceFactory implements FactoryInterface
{
    /**
     ...
     * @return object       [Base\Service\UsersExportToAuditHelperService]
     */
    public function __invoke(ContainerInterface $container, $requestedName, Array $options = null)
    {
        $config = $container->get('Config');

        return new UsersExportToAuditHelperService(
            $config,
