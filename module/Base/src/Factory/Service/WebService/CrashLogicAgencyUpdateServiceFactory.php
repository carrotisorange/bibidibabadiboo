...
namespace Base\Factory\Service\WebService;
...
class CrashLogicAgencyUpdateServiceFactory extends ServiceFactory implements FactoryInterface
{
    /**
     ...
     * @return object       [Base\Service\CrashLogicAgencyUpdateService]
     */
    public function __invoke(ContainerInterface $container, $requestedName, Array $options = null)
    {
        $config = $container->get('Config');

        return new CrashLogicAgencyUpdateService(
            $config,
