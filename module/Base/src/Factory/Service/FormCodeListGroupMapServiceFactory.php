...
class FormCodeListGroupMapServiceFactory extends ServiceFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new FormCodeListGroupMapService(
            $config,
            $container->get('Logger'),
            $this->getFormCodeListGroupMapAdapter($config)
        );
    }
}
