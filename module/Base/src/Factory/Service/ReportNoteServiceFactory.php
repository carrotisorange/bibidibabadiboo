...
class ReportNoteServiceFactory extends ServiceFactory implements FactoryInterface
{
    /**
     ...
     * @return object       [Base\Service\ReportNoteService]
     */
    public function __invoke(ContainerInterface $container, $requestedName, Array $options = null)
    {
        $config = $container->get('Config');
        
        return new ReportNoteService(
            $config,
