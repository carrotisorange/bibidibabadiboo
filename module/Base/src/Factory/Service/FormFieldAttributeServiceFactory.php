...
class FormFieldAttributeServiceFactory extends ServiceFactory implements FactoryInterface
{
    /**
     ...
     * @return object       [Base\Service\FormFieldAttributeService]
     */
    public function __invoke(ContainerInterface $container, $requestedName, Array $options = null)
    {
        $config = $container->get('Config');
        
        return new FormFieldAttributeService(
            $config,
            $container->get('Logger'),
            $this->getFormFieldAttributeAdapter($config)
        );
    }
}
