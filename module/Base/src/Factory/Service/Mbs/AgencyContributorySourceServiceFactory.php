...
use Base\Service\Mbs\AgencyContributorySourceService;
...
class AgencyContributorySourceServiceFactory extends ServiceFactory implements FactoryInterface
{
     ...
     * @return object       [Base\Service\Mbs\AgencyContributorySourceService]
     */
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new AgencyContributorySourceService(
            ...
            $this->getMbsAgencyContributorySourceAdapter($config, $container)
        );
