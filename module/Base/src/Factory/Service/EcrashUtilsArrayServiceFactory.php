...
class EcrashUtilsArrayServiceFactory extends ServiceFactory implements FactoryInterface
{
    /**
    ...
    /**
     * EcrashUtilsArrayService service factory to inject required parameters to user model service
     * @param object        $container      [Interop\Container\ContainerInterface]
     * @param string        $requestedName  Requested model service name
     * @param null|array    $options
     * @return object       [Base\Factory\Service\EcrashUtilsArrayServiceFactory]
     */
    public function __invoke(ContainerInterface $container, $requestedName, Array $options = null)
    {
        $config = $container->get('Config');
        
        return new EcrashUtilsArrayService(
            $config,
