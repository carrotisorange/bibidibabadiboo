...
use Base\Service\Job\PopulateEntryQueueService;
use Base\Service\ReportEntryQueueService;

class PopulateEntryQueueServiceFactory extends ServiceFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, Array $options = null)
    {
        ...
        $jobName = 'PopulateEntryQueue';

        $service = new PopulateEntryQueueService(
            new File($jobName),
