...
class FormCodeListPairMapServiceFactory extends ServiceFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new FormCodeListPairMapService(
            $config,
            $container->get('Logger'),
            $this->getFormCodeListPairMapAdapter($config, $container)
        );
    }
}
